...
/*altor32 U_ALTOR32_CPU (
    ...
    // Instruction memory
    .imem_addr_o        (iwb_adr_o          ),
    .imem_dat_i         (iwb_dat_i          ),
    .imem_cyc_o         (iwb_cyc_o          ),
    .imem_stb_o         (iwb_stb_o          ),
    .imem_ack_i         (iwb_ack_i          ),

    // Data memory
    .dmem_addr_o        (dwb_adr_o          ),
    .dmem_dat_o         (dwb_dat_o          ),
    .dmem_dat_i         (dwb_dat_i          ),
    .dmem_sel_o         (dwb_sel_o          ),
    .dmem_cyc_o         (dwb_cyc_o          ),
    .dmem_we_o          (dwb_we_o           ),
    .dmem_stb_o         (dwb_stb_o          ),
    .dmem_ack_i         (dwb_ack_i          )
);*/
